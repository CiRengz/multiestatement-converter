...
st.write("Unggah file PDF e-Statement BCA. Aplikasi akan mengekstrak transaksi, memisahkan bulan ke dalam sheet, dan mengkalkulasi saldo secara otomatis.")
...
# Area Upload File
uploaded_files = st.file_uploader("Pilih satu atau beberapa file PDF sekaligus", type="pdf", accept_multiple_files=True)

if uploaded_files:
    if st.button("🚀 Proses Data Sekarang"):
        with st.spinner("Sedang membaca PDF dan mengkalkulasi saldo..."):
            sheet_data = {}
            ...
            if sheet_data:
                ...
                # Membangun file Excel di dalam memory (BytesIO) agar bisa didownload via web
                output = io.BytesIO()
                ...
                # Menampilkan tombol download yang interaktif
                st.download_button(
